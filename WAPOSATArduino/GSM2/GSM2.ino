...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"984768790\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
  mySerial.println("Mensaje de Arduino!");//the content of the message
  delay(100);
...
void DialVoiceCall()
{
  mySerial.println("ATD + 984768790;");//dial the number
  delay(100);
  mySerial.println();
}
...
void SubmitHttpRequest()
{
  ...
  mySerial.println("AT+SAPBR=3,1,\"claro.pe\",\"CMNET\"");//setting the APN, the second need you fill in your local apn server
  delay(4000);
