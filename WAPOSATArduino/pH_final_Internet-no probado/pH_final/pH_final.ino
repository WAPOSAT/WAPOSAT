...
byte ip[] = { 172,16,13,69 }; // Direccion ip local
//byte dns[]= {8,8,8,8};
byte gateway[] = { 172, 16, 13, 254 };
//byte subnet[]={255,255,255,0};
byte server[] = { 54, 94, 227, 28 };  // Direccion ip del servidor
...
*/
  ...
  client.stop();
  client.flush();
  delay(120000); // espera 5 minutos antes de volver a sensar la temperatura
  myserial.flush();
}
